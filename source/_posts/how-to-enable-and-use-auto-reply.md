...
**通过B站的自动回复/自动推送功能发送的私信不会被B站视作“对方关注或回复你之前，你只能发送1条文字消息”规则中的“回复你”与“发送1条文字消息”，即自动回复/自动推送功能不会被上述规则所限制，但也不能解除手动私信的这一限制**。这意味着，在您未关注且从来没有手动私信对方的情况下，即使对方触发了您的自动回复，对方**仍然会受到“只能手动发送1条文字消息”的限制**，但仍可以自动回复您；同样，如果对方并没有手动私信或关注您，即使您给对方自动回复了，您**也会受到“只能手动发送1条文字消息”的限制**，但是您可以自动回复对方。
